...
class _PageBodyState extends State<PageBody> {
      ...
      children: [
          ...
          return PopularProduct.isLoaded
              ? Container(
                  ...
                  child: PageView.builder(
                      ...
                      itemCount: PopularProduct.PopulatProductList.length >= 1
                          ? PopularProduct.PopulatProductList.length
                          : 1,
                      itemBuilder: (context, position) {
                        return _Pageitem(
                            position,
                            PopularProduct.PopulatProductList[position],
                            PopularProduct);
                      }),
                )
        ...
        GetBuilder<PopularProductController>(builder: (PopularProduct) {
          return DotsIndicator(
            dotsCount: PopularProduct.PopulatProductList.length >= 1
                ? PopularProduct.PopulatProductList.length
                : 1,
        ...
        Container(
          margin: EdgeInsets.all(Dimension.Screenheight / 50),
          child: Row(
            ...
            children: [
              BigText(
                  ...
                  text: "Recommended",
                  size: Dimension.Screenheight / 38),
              SizedBox(
                width: Dimension.Screenheight / 81,
              ),
              Container(
          ...
          return RecomendedProduct.isLoaded
              ? Padding(
                  ...
                  child: ListView.builder(
                      itemCount:
                          RecomendedProduct.RecommendedProductList.length,
                      physics: NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemBuilder: (context, index) => GestureDetector(
                            onTap: () {
                              Get.toNamed(
                                  RouteHelper.getRecommendedProduct(index));
                            },
                            child: Container(
                              child: Row(
                                children: [
  ...
  Widget _Pageitem(
    int index,
    Products_Models populatProduct,
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        SmalText(
                            TextColor: Colors.black26,
                            text: populatProduct.stars.toString(),
                            size: size.width * 0.03),
                        SizedBox(
                          width: 10,
                        ),
